<?php 
	...
	$user_data = $login->check_login($_SESSION['readbook_userid'],false);
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST')
	{
		...
		}else
		{
			...
			header("Location:" . ROOT ."profile/".$_SESSION['readbook_userid']. "/groups");
			die;
		}
...
<html> 
	...
	<head>
		...
		<title>Readbook | Create Group</title>
	</head>
